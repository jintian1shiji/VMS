...
namespace HKCamera
{
    ...
    public class CHCNetSDK
    {
        ...
        **********************************************************/
        ...
        Return:	
        **********************************************************/
        public delegate void STDDATACALLBACK(Int32 lRealHandle, UInt32 dwDataType, IntPtr pBuffer, UInt32 dwBufSize, UInt32 dwUser);

        [DllImport("HCNetSDK")]
        public static extern bool NET_DVR_SetStandardDataCallBack(Int32 lRealHandle, STDDATACALLBACK fStdDataCallBack, uint dwUser);
