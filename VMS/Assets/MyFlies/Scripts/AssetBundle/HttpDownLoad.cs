...
public class HttpDownLoad:MonoBehaviour
{
    ...
    void Start()
    {
        DownLoad("http://127.0.0.1:8080/NBKSS/StreamingAssets/Cursor/hand.png", Application.streamingAssetsPath + "/Temp/", "hand.png", callBackAction);
    }
    ...
    public void DownLoad(string url, string savePath, string fileName, Action callBack, System.Threading.ThreadPriority threadPriority = System.Threading.ThreadPriority.Normal)
    {
        ...
        thread = new Thread(delegate () {
            ...
            Debug.Log(fs.Length);
            //获取下载文件的总长度
            //Debug.Log(url + " " + fileName + " " + fileLength);
            long totalLength = GetLength(url);
            //Debug.Log("--fileLength-- " + fileLength + " " + " --totalLength-- " + totalLength);
